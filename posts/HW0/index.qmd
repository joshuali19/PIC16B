...
Since this is not necessarily a data cleaning class, I will not explain too much about what to look out for, but the code will be provided for you to look through.
```{python}
#| code-fold: true
...
p_cleaned = p_cleaned[p_cleaned.Sex != '.']
...
For this example, we will use `matplotlib` to create my visualization. As stated above, we will use a scatter plot to display this information. The necessary parameters for a scatter plot are the x
